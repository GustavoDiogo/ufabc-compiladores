...
public class IsiLangLexer extends Lexer {
	...
	public static final int
		...
		T__9=10, T__10=11, T__11=12, AP=13, FP=14, PF=15, OP=16, ATTR=17, VIR=18, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "AP", "FP", "PF", "OP", "ATTR", "VIR", "ACH", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, "AP", "FP", "PF", "OP", "ATTR", "VIR", "ACH", "FCH", "OPREL", "BOOLEAN", 
